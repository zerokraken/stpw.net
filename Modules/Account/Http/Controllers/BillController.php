...
use Modules\Account\Entities\BillAccount;
...
class BillController extends Controller
{
    ...
    public function BillSectionGet(Request $request)
    {
        ...
        if($request->type == "product")
        {
            ...
            $returnHTML = view('account::bill.section',compact('product_services','type' ,'acction','bill','product_services_count','product_type','chartAccounts'))->render();
                $response = [
                    'is_success' => true,
                    'message' => '',
                    'html' => $returnHTML,
