...
@php
    $path = url("/Modules/Fleet/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__('Your all-in-one solution for vehicle booking, order tracking, payment history, fuel management,Maintenance Manage, and Insurance plans')}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{ __('Complete Vehicle Management System')}}</h2>
                <p>{{__('Fleet gives users deep insight into their maintenance needs with detailed Vehicle Bookings, Vehicles,Maintenance,insurance , dashboards')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Fleet makes it easy to manage Vehicles')}}</h2>
                        </div>
                        <p>{{__('In vehicle management, you can keep a list of how many vehicles your company has or how many new ones have arrived, and you can also create where the driver is to be assigned to that vehicle.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    ...
                                    <span>{{__('Esy to manage vehicles types')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('In it you can add vehicle types according to your management system')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Most effective way to manage your Booking system')}}</h2>
                        </div>
                        <p>{{__('A booking system you can mange the booking coming to your company and can also manage its payment and you can also see how much amount has been paid in the booking payment.')}}</p>
                        <div class="theme-acnav">
                            <div class="set has-children">
                                <a href="javascript:;" class="acnav-label">
                                    <span class="acnav-icon">
                                    ...
                                    <span>{{__('Manage Booking Payment')}}</span>
                                </a>
                                <div class="acnav-list">
                                    <p>{{__('Its payment and you can also see how much amount has been paid in booking payment and also manage how much amount is pending.')}}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Manage Maintenance')}}</h2>
                        </div>
                        <p>{{__('In Fleet Management, you are also given a maintenance management system of your vehicle in which you can manage the maintenance of the entire vehicle and where you can add employees with cost, priority, total cost etc.')}}</p>
                    </div>
                </div>
                <div class="col-lg-7 col-md-6 col-12">
                    <div class="dash-theme-preview">
