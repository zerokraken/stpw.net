                ...
                <div class="col-lg-9 col-md-7 col-12">
                    <div class="common-banner-content">
                        <div class="section-title text-center">
                            ...
                            <p><?php echo e(__('Lay a solid foundation for your fashion brand. Grab a high-converting fashion theme
    ...
    <section class="product-listing-section padding-bottom">
        <div class="container">
                                        ...
                                        <div class="product-card-inner">
                                            <div class="product-img">
                                                <div class="theme-avtar">
                                                    <a target="_new" href="<?php echo e(route('software.details',Module_Alias_Name($module->getName()))); ?>">
                                            ...
                                            <div class="product-content">
                                                ...
                                                <h4> <a target="_new" href="<?php echo e(route('software.details',Module_Alias_Name($module->getName()))); ?>"><?php echo e(Module_Alias_Name($module->getName())); ?></a> </h4>
                                                <div class="price">
                                                ...
                                                <a target="_new" href="<?php echo e(route('software.details',Module_Alias_Name($module->getName()))); ?>" class="btn cart-btn"><?php echo e(__('View Details')); ?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php endif; ?>
            ...
            <div class="listing-info padding-top ">
                <p><?php echo e(__('An effective fashion theme should be visually appealing and easy to navigate. A good theme makes it easy for customers to find and buy the items they’re interested in. The theme should also be responsive so that it looks good on all devices.')); ?></p>
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/marketplace/software.blade.php ENDPATH**/ ?>