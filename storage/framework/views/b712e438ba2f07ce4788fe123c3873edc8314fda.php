...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="col-xl-6 img-card-side">
            <div class="auth-img-content">
                <img src="assets/images/auth/img-auth-3.png" alt="" class="img-fluid">
                <div align="center"><h2 class="text-white mb-4 mt-5"> <?php echo e(__('WELCOME TO STPW')); ?></h2></dev>
                <div align="center"><h2><p class="text-white"> <?php echo e(__('FLEET MANAGEMENT SYSTEM')); ?></p></h2></dev>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/auth/login.blade.php ENDPATH**/ ?>