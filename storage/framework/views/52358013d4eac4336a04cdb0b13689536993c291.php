...
<head>
    ...
    <title><?php echo $__env->yieldContent('page-title'); ?> | <?php echo e(!empty(admin_setting('title_text')) ? admin_setting('title_text') :'WorkDo-Dash'); ?></title>
    ...
    <?php if(admin_setting('site_rtl') == 'on'): ?>
...
<body class="<?php echo e(!empty(admin_setting('color'))?admin_setting('color'):'theme-1'); ?>" >
    ...
    <header class="site-header header-style-one">
        ...
        <div class="announcebar bg-dark text-center">
            <?php echo $settings['topbar_notification_msg']; ?>
                ...
                <div class="navigationbar-row d-flex align-items-center justify-content-between">
                    <div class="logo-col">
                        <a href="<?php echo e(route('start')); ?>">
                            <img src="<?php echo e(check_file($settings['site_logo']) ? get_file($settings['site_logo']) : get_file('uploads/logo/logo_dark.png')); ?>" alt="">
                        </a>
                    </div>
                    <div class="menu-items-col">
                        <ul class="main-nav">
                            <li class="menu-lnk">
                                <a href="<?php echo e(url('/')); ?>"><?php echo e($settings['home_title']); ?></a>
                            </li>
                            <li class="menu-lnk">
                                <a href="<?php echo e(route('apps.software')); ?>"><?php echo e(__('Add-on')); ?></a>
                            </li>
                            <li class="menu-lnk">
                            ...
                            <?php if(is_array(json_decode($settings['menubar_page'])) || is_object(json_decode($settings['menubar_page']))): ?>
                                <?php $__currentLoopData = json_decode($settings['menubar_page']); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($value->header == 'on'): ?>
                                        <?php if($value->template_name == 'page_content'): ?>
                                            <li class="menu-lnk">
    ...
    <div class="home-wrapper">
                    ...
                    <div class="row row-gap align-items-center">
                        <div class="col-md-6 col-12">
                            <div class="banner-content">
                                <h1><?php echo e($settings['home_heading']); ?>

                                </h1>
                                <p><?php echo e($settings['home_description']); ?></p>
                                <div class="btn-group">
                                    <a href="<?php echo e(route('apps.pricing')); ?>" class="btn"><?php echo e(__('Get the Package')); ?> <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <a href="<?php echo e($settings['home_live_demo_link']); ?>" class="link-btn"><?php echo e(__('View Live Demo')); ?> <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="col-md-6 col-12">
                            <div class="banner-image-wrapper">
                                ...
                                <div class="banner-img-wrapper">
                                    <img src="<?php echo e(asset('market_assets/images/banner-image.png')); ?>" alt=""  class="main-banner" >
                                    <img src="<?php echo e(asset('market_assets/images/banner-image-rtl.png')); ?>" alt=""  class="rtl-banner">
                                    <img src="<?php echo e(check_file($settings['home_banner']) ? get_file($settings['home_banner']) : $old_path."/images1.png"); ?>" alt="" class="inner-frame-img">
                            </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="exclusive-partners">
                    <div class="container">
                        <div class="section-title">
                            <p><?php echo e($settings['home_trusted_by']); ?></p>
                        </div>
                        <div class="partners-logo-slider">
                            <?php for($i = 1; $i < 15; $i++): ?>
                                <div class="logo-item">
                                    <a href="#">
                                        <img src="<?php echo e(check_file($settings['home_logo']) ? get_file($settings['home_logo']) : $old_path."/logo-dark.png"); ?>" alt="exclusive partner">
                                    </a>
                                </div>
                            <?php endfor; ?>
                        </div>
                                ...
                                <div class="col-lg-4 col-md-6 col-12 support-card">
                                    <div class="support-card-inner">
                                        <div class="support-card-media">
                                            <div class="card-icon">
                                                <?php if(check_file($value['feature_logo'])): ?>
                                                    <img src="<?php echo e(get_file($value['feature_logo'])); ?>" alt="">
                                                <?php else: ?>
                                        ...
                                        <div class="support-content">
                                            <h3><?php echo $value['feature_heading']; ?></h3>
                                            <p><?php echo $value['feature_description']; ?></p>
                                        </div>
                                        <div class="support-content-bottom">
                                            <a href="<?php echo $value['feature_more_details_link']; ?>" class="btn"><?php echo $value['feature_more_details_button_text']; ?> <svg xmlns="http://www.w3.org/2000/svg" width="16"
            ...
            <section class="dedicated-themes-section">
                <div class="container">
                    <div class="section-title text-center padding-bottom">
                        <h2> <?php echo $settings['highlight_feature_heading']; ?></h2>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5 col-md-6 col-12">
                                                <div class="abt-theme">
                                                    <div class="section-title">
                                                        <div class="subtitle">
                                                            <?php echo $value['other_features_tag']; ?>

                                                        </div>
                                                        <h2><?php echo $value['other_features_heading']; ?></h2>
                                                    </div>
                                                    <p><?php echo $value['other_featured_description']; ?></p>
                                                    <?php if(!empty($value['cards'])): ?>
                                                        <?php $__currentLoopData = $value['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="col-lg-7 col-md-6 col-12">
                                                <div class="dash-theme-preview">
                                                    <img src="<?php echo e(check_file($value['other_features_image']) ? get_file($value['other_features_image']) : $old_path."/account_image1.png"); ?>" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="bg-white padding-bottom ">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-7  col-md-6 col-12">
                                                <div class="dash-theme-preview">
                                                    <img src="<?php echo e(check_file($value['other_features_image']) ? get_file($value['other_features_image']) : $old_path."/hrm_image1.png"); ?>" alt="">
                                                </div>
                                            </div>
                                            <div class="col-lg-5 col-md-6 col-12">
                                                <div class="abt-theme">
                                                    ...
                                                    <p><?php echo $value['other_featured_description']; ?></p>
                                                    <?php if(!empty($value['cards'][1]['title']) && $value['cards'][1]['title'] != null && $value['cards'][1]['title'] != ''): ?>
                                                        <div class="theme-acnav">
                                                            <?php $__currentLoopData = $value['cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <div class="set has-children">
                                                                    <a href="javascript:;" class="acnav-label">
        ...
        <?php if(isset($settings['feature_status'])): ?>
            <section class="review-section padding-bottom padding-top">
                <div class="container">
                    <div class="review-slider">
                        <?php if(is_array(json_decode($settings['reviews'], true)) ||
                        is_object(json_decode($settings['reviews'], true))): ?>
                            <?php $__currentLoopData = json_decode($settings['reviews'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="review-content-itm">
                                    <div class="review-content">
                                        <div class="section-title">
                                            ...
                                            <div class="subtitle">
                                                <?php echo $value['review_header_tag']; ?>

                                            </div>
                                            <h2>  <?php echo $value['review_heading']; ?></h2>
                                        </div>
                                        <p> <?php echo $value['review_description']; ?> </p>
                                        <div class="btn-group">
                                            <a href="<?php echo e(route('apps.pricing')); ?>" class="btn btn-white"><?php echo e(__('Get the Package')); ?> <svg
                                            ...
                                            <a href="<?php echo $value['review_live_demo_link']; ?>" class="link-btn"><?php echo $value['review_live_demo_button_text']; ?><svg xmlns="http://www.w3.org/2000/svg"
                                                    width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <g clip-path="url(#clip0_7_820)">
                                                        <path
                                                            d="M9.33984 1.18359L9.33985 18.519L4.612 18.519C2.87125 18.519 1.4601 17.1079 1.4601 15.3671L1.4601 4.33549C1.4601 2.59475 2.87125 1.18359 4.612 1.18359L9.33984 1.18359Z"
                            ...
                            <?php $__currentLoopData = json_decode($settings['screenshots'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="theme-preview-itm">
                                    <div class="preview-itm">
                                        <img src="<?php echo e(check_file($value['screenshots']) ? get_file($value['screenshots']) : $old_path."/hrm_image1.png"); ?>" alt="<?php echo e($value['screenshots_heading']); ?>">
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
        ...
        <!-- [ dedicated ] start -->
        <?php if($settings['dedicated_section_status'] == 'on'): ?>
            <section class="dedicated-section padding-top  padding-bottom">
                <div class="container">
                    <div class="section-title text-center">
                        <h2><?php echo e($settings['dedicated_heading']); ?></b></h2>
                        <p><?php echo $settings['dedicated_description']; ?></p>
                        <div class="btn-group">
                            <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Get the Package')); ?> <svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <g clip-path="url(#clip0_14_726)">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M5.88967 10.9856C6.96087 11.2611 7.75238 12.233 7.75238 13.3897C7.75238 14.7607 6.64043 15.8721 5.26877 15.8721C3.89711 15.8721 2.78516 14.7607 2.78516 13.3897C2.78516 12.233 3.57667 11.2611 4.64787 10.9856V10.5959C4.64787 8.7099 6.1768 7.18097 8.06283 7.18097C9.26304 7.18097 10.236 6.20801 10.236 5.00781V3.09158L8.81233 4.51524C8.56985 4.75772 8.17672 4.75772 7.93424 4.51524C7.69176 4.27276 7.69176 3.87963 7.93424 3.63715L10.4179 1.15354C10.6603 0.91106 11.0535 0.91106 11.2959 1.15354L13.7796 3.63715C14.022 3.87962 14.022 4.27276 13.7796 4.51524C13.5371 4.75771 13.1439 4.75772 12.9015 4.51524L11.4778 3.09158V5.00781C11.4778 6.89384 9.94887 8.42278 8.06283 8.42278C6.86263 8.42278 5.88967 9.39573 5.88967 10.5959V10.9856ZM6.51058 13.3897C6.51058 14.0743 5.95517 14.6303 5.26877 14.6303C4.58237 14.6303 4.02696 14.0743 4.02696 13.3897C4.02696 12.7052 4.58237 12.1492 5.26877 12.1492C5.95517 12.1492 6.51058 12.7052 6.51058 13.3897Z"
                            ...
                            <a href="<?php echo e($settings['dedicated_live_demo_link']); ?>" class="link-btn"><?php echo e($settings['dedicated_link_button_text']); ?> <svg xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <div class="row row-gap justify-content-center ">
                        <?php if(is_array(json_decode($settings['dedicated_card_details'], true)) || is_object(json_decode($settings['dedicated_card_details'], true))): ?>
                            <?php $__currentLoopData = json_decode($settings['dedicated_card_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                <div class="col-lg-4 col-md-6 col-12 information-card">
                                    <div class="information-card-inner">
                                        <div class="card-icon">
                                                <img src="<?php echo e(get_file($value['dedicated_card_logo'])); ?>" alt="">
                                        </div>
                                        <div class="information-content">
                                            <h5><?php echo e($value['dedicated_card_heading']); ?></h5>
                                            <p><?php echo $value['dedicated_card_description']; ?></p>
                                            <a href="<?php echo e($value['dedicated_card_more_details_link']); ?>" class="btn btn-white" tabindex="0"><?php echo e($value['dedicated_card_more_details_button_text']); ?> <svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                                    fill="none">
                                                    <g clip-path="url(#clip0_14_726)">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <?php if($settings['buildtech_section_status'] == 'on'): ?>
            <section class="built-technology">
                <div class="container">
                    <div class="section-title text-center">
                        <h2><?php echo e($settings['buildtech_heading']); ?></h2>
                        <p><?php echo $settings['buildtech_description']; ?></p>
                    </div>
                    <div class="row row-gap justify-content-center">

                        <?php if(is_array(json_decode($settings['buildtech_card_details'], true)) || is_object(json_decode($settings['buildtech_card_details'], true))): ?>
                            <?php $__currentLoopData = json_decode($settings['buildtech_card_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12 information-card">
                                    <div class="information-card-inner">
                                        <div class="card-icon">
                                            <img src="<?php echo e(get_file($value['buildtech_card_logo'])); ?>" alt="">
                                        </div>
                                        <div class="information-content">
                                            <h5><?php echo e($value['buildtech_card_heading']); ?></h5>
                                            <p><?php echo $value['buildtech_card_description']; ?></p>
                                            <a href="<?php echo e($value['buildtech_card_more_details_link']); ?>" class="btn btn-white" tabindex="0"><?php echo e($value['buildtech_card_more_details_button_text']); ?> <svg
                                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16"
                                                    fill="none">
                                                    <g clip-path="url(#clip0_14_726)">
                                                        <path fill-rule="evenodd" clip-rule="evenodd"
        ...
        <?php if($settings['packagedetails_section_status'] == 'on'): ?>
            <section class="package-detail-section padding-top">
                <div class="container">
                    <div class="section-title text-center">
                        <h2><?php echo e($settings['packagedetails_heading']); ?></h2>
                        <p><?php echo $settings['packagedetails_short_description']; ?></p>
                        <div class="btn-group">
                            <a href="<?php echo e($settings['packagedetails_link']); ?>" class="btn-secondary"><?php echo e($settings['packagedetails_button_text']); ?> <svg xmlns="http://www.w3.org/2000/svg"
                                    width="16" height="16" viewBox="0 0 16 16" fill="none">
                                    <g clip-path="url(#clip0_14_726)">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            d="M5.88967 10.9856C6.96087 11.2611 7.75238 12.233 7.75238 13.3897C7.75238 14.7607 6.64043 15.8721 5.26877 15.8721C3.89711 15.8721 2.78516 14.7607 2.78516 13.3897C2.78516 12.233 3.57667 11.2611 4.64787 10.9856V10.5959C4.64787 8.7099 6.1768 7.18097 8.06283 7.18097C9.26304 7.18097 10.236 6.20801 10.236 5.00781V3.09158L8.81233 4.51524C8.56985 4.75772 8.17672 4.75772 7.93424 4.51524C7.69176 4.27276 7.69176 3.87963 7.93424 3.63715L10.4179 1.15354C10.6603 0.91106 11.0535 0.91106 11.2959 1.15354L13.7796 3.63715C14.022 3.87962 14.022 4.27276 13.7796 4.51524C13.5371 4.75771 13.1439 4.75772 12.9015 4.51524L11.4778 3.09158V5.00781C11.4778 6.89384 9.94887 8.42278 8.06283 8.42278C6.86263 8.42278 5.88967 9.39573 5.88967 10.5959V10.9856ZM6.51058 13.3897C6.51058 14.0743 5.95517 14.6303 5.26877 14.6303C4.58237 14.6303 4.02696 14.0743 4.02696 13.3897C4.02696 12.7052 4.58237 12.1492 5.26877 12.1492C5.95517 12.1492 6.51058 12.7052 6.51058 13.3897Z"
                    ...
                    <div class="description">
                        <?php echo $settings['packagedetails_long_description']; ?>
    ...
    <!-- Footer start here -->
    <?php if($settings['footer_status'] == 'on'): ?>
        <footer class="site-footer">
            <div class="container">
                <div class="footer-top">
                    <div class="footer-logo">
                        <a href="<?php echo e(route('start')); ?>">
                            <img src="<?php echo e(check_file($settings['footer_logo']) ? get_file($settings['footer_logo']) : get_file('uploads/logo/logo_light.png')); ?>" alt="logo">
                        </a>
                    </div>
                    ...
                    <div class="footer-top-right">
                        <ul>
                            <li>
                                <a href="<?php echo e($settings['footer_live_demo_link']); ?>" class="btn-secondary"><?php echo e(__('Go to Shop')); ?><svg
                            ...
                            <li>
                                <a href="<?php echo e($settings['footer_support_link']); ?>" class="btn-link"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                ...
                <div class="footer-row">
                    <div class="footer-col  about-site">
                        <p><?php echo $settings['footer_description']; ?></p>
                        <p><?php echo $settings['all_rights_reserve_text']; ?><br>
                            <a href="<?php echo $settings['all_rights_reserve_website_url']; ?>"><?php echo $settings['all_rights_reserve_website_name']; ?></a>
                        </p>
                    </div>
                    <!-- Footer section start here -->
                    <?php if(is_array(json_decode($settings['footer_sections_details'], true)) || is_object(json_decode($settings['footer_sections_details'], true))): ?>
                            <?php $__currentLoopData = json_decode($settings['footer_sections_details'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="footer-col footer-link footer-link-1">
                                    <div class="footer-widget">
                                        <h4><?php echo e($value['footer_section_heading']); ?></h4>
                                        <ul>
                                            <?php if(isset($value['footer_section_text']) || !empty($value['footer_section_text'])): ?>
                                                <?php $__currentLoopData = $value['footer_section_text']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $text): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li><a href="<?php echo e($text['link']); ?>"><?php echo e($text['title']); ?></a></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>    
                                            <?php endif; ?>  
                                        </ul>
                                    </div>
                    ...
                    <div class="footer-col  footer-subscribe-col">
                        <div class="footer-widget">
                            <h4><b><?php echo $settings['joinus_heading']; ?></b></h4>
                            <p> <?php echo $settings['joinus_description']; ?> </p>
                            <form method="post" action="<?php echo e(route('join_us_store')); ?>" class="footer-subscribe-form">
                                <?php echo csrf_field(); ?>
                                <div class="input-wrapper">
                                    <input type="email" name="email" placeholder="Type your email address...">
                                    <button type="submit" class="btn-subscibe"><?php echo e(__('Join Us!')); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
...
</html><?php /**PATH /home/u886959491/domains/stpw.net/public_html/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>