                ...
                <div class="navigationbar-row d-flex align-items-center justify-content-between">
                    <div class="logo-col">
                        <a href="<?php echo e(route('start')); ?>">
                            <img src="<?php echo e(get_file(sidebar_logo())); ?><?php echo e('?'.time()); ?>">
                        </a>
                    </div>
        ...
        <div class="container">
            <div class="footer-top">
                <div class="footer-logo">
                    <a href="<?php echo e(route('start')); ?>">
                        <img src="<?php echo e(get_file(light_logo())); ?><?php echo e('?'.time()); ?>" alt="">
                    </a>
                </div>
                ...
                <div class="footer-top-right">
                    <ul>
                        <li>
                            <a href="#" class="btn-secondary"><?php echo e(__('Go to Shop')); ?><svg
            ...
            <div class="footer-row">
                <div class="footer-col  about-site">
                    <p><?php echo e(__('We build modern web tools to help you jump-start your daily business work.')); ?></p>
                    <p><?php echo e(__('All Rights Reserved to')); ?><br>
                        <a href="#"><?php echo e(__('Rajodiya.com')); ?></a>
                    </p>
                </div>
                <div class="footer-col footer-link footer-link-1">
                    <div class="footer-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><?php echo e(__('Freebies')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Premium')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Blog')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Affiliate Program')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Get coupon')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="footer-col footer-link footer-link-2">
                    <div class="footer-widget">
                        <h4><?php echo e(__('Help and Support')); ?></h4>
                        <ul>
                            <li><a href="#"><?php echo e(__('Knowledge Center')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Contact Us')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Premium Support')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Sponsorships')); ?></a></li>
                            <li><a href="#"><?php echo e(__('Custom Development')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="footer-col footer-link footer-link-2">
                    <div class="footer-widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#"><?php echo e(__('Licenses')); ?></a></li>
                        </ul>
                    </div>
                </div>
                <div class="footer-col  footer-subscribe-col">
                    <div class="footer-widget">
                        <h4><b><?php echo e(__('Join Our')); ?></b><?php echo e(__('Community')); ?></h4>
                        <p> <?php echo e(__('We build modern web tools to help you jump-start your daily business work.')); ?> </p>
                        <form class="footer-subscribe-form">
                            <div class="input-wrapper">
                                <input type="email" placeholder="Your email address...">
                                <button type="submit" class="btn-subscibe"><?php echo e(__('Join')); ?></button>
                            </div>
                        </form>
                    </div>
                </div>
...
<?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/marketplace/marketplace.blade.php ENDPATH**/ ?>