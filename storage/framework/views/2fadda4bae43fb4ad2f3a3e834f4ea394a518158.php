                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                    <tr>
                                                        <td style="font-size:0px;padding:10px 25px;padding-top:0px;padding-right:0px;padding-bottom:40px;padding-left:0px;word-break:break-word;">
                                                            <p style="border-top:solid 7px #008aff;font-size:1;margin:0px auto;width:100%;">
                                                            </p>

                                                            <table align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 7px #008aff;font-size:1;margin:0px auto;width:600px;" role="presentation" width="600px">
                                                                <tr>
                                                            ...
                                                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                                ...
                                                                <tr>
                                                                    <td style="width:110px;">
                                                                        <img alt="" height="auto" src="<?php echo e(get_file(sidebar_logo())); ?>" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110"/>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
                                                                ...
                                                                <p style="margin: 10px 0;">
                                                                    <i style="font-style:normal">
                                                                        <b style="font-weight:700">
                                                                            ...
                                                                            <?php else: ?>
                                                                                <?php echo e(!empty( company_setting('company_name')) ?  company_setting('company_name') : env('APP_NAME')); ?>
...
<?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/email/test_mail.blade.php ENDPATH**/ ?>