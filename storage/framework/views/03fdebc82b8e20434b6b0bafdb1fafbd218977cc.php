...
<?php $__env->startSection('page-action'); ?>
    <div>
        <a href="<?php echo e(route('active.plans')); ?>" class="btn-submit btn btn-sm btn-primary " data-toggle="tooltip"
                                ...
                                <div class="">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                <div class="">
                                                                    <label for="bank-payment">
                                                                        <h5 class="mb-0 text-capitalize pointer"><?php echo e(__('Bank Transfer')); ?></h5>
                                                                    </label>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="cart-footer-total-row bg-primary text-white rounded p-3 d-flex align-items-center justify-content-between">
                                        <div class="mini-total-price">
                                            <div class="price">
                                                <h3 class="text-white mb-0 total"><?php echo e('0.00'.$currancy_symbol); ?></h3>
                                        ...
                                        <?php echo e(Form::open(array('','method'=>'post','id'=>'payment_form','enctype' => 'multipart/form-data'))); ?>
                                            ...
                                            <input type="hidden" name="user_counter_input" value="<?php echo e(!empty($plan->number_of_user) ? $plan->number_of_user: -1); ?>" class="user_counter_input">
                                            <input type="hidden" name="workspace_counter_input" value="<?php echo e(!empty($plan->number_of_workspace) ? $plan->number_of_workspace : -1); ?>" class="workspace_counter_input">
                                            <input type="hidden" name="user_module_input" value="<?php echo e($plan->modules); ?>" name="user_module_input"
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
        ...
        $( "#payment_form" ).on( "submit", function( event ) {
            "<?php echo e(session()->put('Subscription','plan_subscription')); ?>";
        });
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/plans/planpayment.blade.php ENDPATH**/ ?>