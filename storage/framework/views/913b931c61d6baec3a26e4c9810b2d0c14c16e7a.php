<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function packages(plan_package = null, custome_package = null) {
            $.ajax({
                url: '<?php echo e(route('package.data')); ?>',
                type: 'POST',
                data: {
                ...
                success: function(data) {
                    ...
                    if (data.custome_package == 'off') {
                        var url = '<?php echo e(route('plan.list')); ?>';
                        window.location.replace(url)
                    }
                    if (data.plan_package == 'off') {
                        var url = '<?php echo e(route('plans.index')); ?>';
                        window.location.replace(url)
                    }
                    if (data == 'error') {
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/plans/plan_script.blade.php ENDPATH**/ ?>