                        ...
                        <div class="package-card">
                            <div class="package-card-inner">
                                ...
                                <div class="price text-end">
                                    <ins class="plan-price-text"><?php echo e($planprice . ' ' . admin_setting('defult_currancy')); ?></ins>
                                        ...
                                        <div class="product-card-inner">
                                                    <div class="product-img">
                                                        <div class="theme-avtar">
                                                            <a href="<?php echo e(route('software.details',Module_Alias_Name($module->getName()))); ?>">
                                                        ...
                                                        <div class="checkbox-custom">
                                                            ...
                                                            data-module-img="<?php echo e(get_module_img($module->getName())); ?>"
                                                            data-module-price-monthly="<?php echo e(ModulePriceByName($module->getName())['monthly_price']); ?>"
                                                            data-module-price-yearly="<?php echo e(ModulePriceByName($module->getName())['yearly_price']); ?>"
                                                            data-module-alias="<?php echo e(Module_Alias_Name($module->getName())); ?>"
                                                    ...
                                                    <div class="product-content">
                                                        ...
                                                        <div class="price d-flex justify-content-between">
                                                            <ins class="m-price-monthly"><span class="currency-type"><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price'])); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Month')); ?></span></ins>
                                                            <ins class="m-price-yearly d-none"><span class="currency-type"><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price'])); ?></span> <span class="time-lbl text-muted"><?php echo e(__('/Year')); ?></span></ins>
                                                        </div>
                        ...
                        <div class="summery-footer">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span class="cart-sum-right"><b class="planpricetext"><?php echo e(($planprice > 0 ) ? $planprice . $currancy_symbol : 'Free'); ?></b></span>
                                </li>
                                <li>
                                    <span class="cart-sum-left"><h6 class="mb-0"><?php echo e(__('Workspace')); ?> <small
                                        class="text-muted workspace-price"><?php echo e('( Per Workspace ' . $workspaceprice .$currancy_symbol . ' )'); ?></small></h6></span>
                                    <span class="cart-sum-right"><b class="workspacepricetext"><?php echo e('0.00'.$currancy_symbol); ?></b></span>
                                </li>
                                <li>
                                    <span class="cart-sum-left"><h6 class="mb-0"><?php echo e(__('Users')); ?> <small
                                        class="text-muted user-price"><?php echo e('( Per User ' . $userprice .$currancy_symbol . ' )'); ?></small></h6></span>
                                    <span class="cart-sum-right"><b class="userpricetext"><?php echo e('0.00'.$currancy_symbol); ?></b></span>
                                </li>
                                <li>
                                    <span class="cart-sum-left"><h6 class="mb-0"><?php echo e(__('Extension')); ?>:</h6></span>
                                    <span class="cart-sum-right"><b class="module_price_text"><?php echo e('0.00'.$currancy_symbol); ?></b></span>
                                </li>
                            </ul>
                            <div class="cart-footer-total-row d-flex align-items-center justify-content-between">
                                <div class="mini-total-price">
                                    <div class="price">
                                        <ins><span class="currency-type total"><?php echo e('0.00'.$currancy_symbol); ?></span></ins>
                                ...
                                <button type="button" class="btn btn-dark user-register-btn"><?php echo e(__('Buy Now')); ?></button>
                            </div>
                ...
                <div class="review-content-itm">
                    <div class="review-content">
                        <div class="section-title">
                            ...
                            <h2><?php echo e(__('A style theme, together with a dedicated Laravel backend')); ?> <b><?php echo e(__('and an intuitive mobile app')); ?></b></h2>
                        </div>
                        <p><?php echo e(__('gives your business an unfair advantage. The package doesn’t just provide you with everything you need to start selling online. It gives you a solid foundation for an eCommerce business for years to come.”')); ?> </p>
                        <div class="btn-group">
                ...
                <div class="review-content-itm">
                    <div class="review-content">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="#" class="link-btn"><?php echo e(__('View Live Demo')); ?> <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <small class="text-danger password-msg d-none"><?php echo e(__('Passwords do not match!')); ?></small>
                        </div>
                    </div>
                </div>
            </div>
...
<?php $__env->startPush('scripts'); ?>
    ...
    <script>
       $(document).on("click",".switch-change",function()
       {
            ...
            $(".plan-price-text").text(planprice + ' <?php echo e(admin_setting("defult_currancy")); ?>');
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/marketplace/pricing.blade.php ENDPATH**/ ?>