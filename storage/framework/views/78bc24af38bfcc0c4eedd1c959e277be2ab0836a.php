...
<div class="wrapper">
    ...
    <!-- product main start -->
    <?php if($marketplace['product_main_status'] == 'on'): ?>
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-summery">
                            <div class="section-title">
                                <h2><?php echo e(Module_Alias_Name($module->getName())); ?></h2>
                            </div>
                            <p><?php echo $marketplace['product_main_description']; ?></p>
                            <div class="price">
                            ...
                            <div class="cart-view btn-group">
                                <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Buy Now')); ?> <svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <a href="<?php echo $marketplace['product_main_demo_link']; ?>" class="link-btn"><?php echo $marketplace['product_main_demo_button_text']; ?> <svg xmlns="http://www.w3.org/2000/svg"
                    ...
                    <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                        <div class="pdp-image-wrapper">
                            <div class="pdp-media banner-img-wrapper">
                                <img src="<?php echo e(asset('market_assets/images/banner-image.png')); ?>" alt="">

                                <img src="<?php echo e(check_file($marketplace['product_main_banner']) ? get_file($marketplace['product_main_banner']) : get_file($old_path."/image1.png")); ?>" alt="" class="inner-frame-img">
                        </div>
                        </div>
                    </div>
                </div>
    ...
    <?php if($marketplace['dedicated_theme_section_status'] == 'on'): ?>
        <section class="dedicated-themes-section ">
            <div class="container">
                <div class="section-title text-center">
                    <h2><?php echo $marketplace['dedicated_theme_heading']; ?></h2>
                    <p><?php echo $marketplace['dedicated_theme_description']; ?></p>
                </div>
                <?php if(is_array(json_decode($marketplace['dedicated_theme_sections'], true)) || is_object(json_decode($marketplace['dedicated_theme_sections'], true))): ?>
                    <?php $__currentLoopData = json_decode($marketplace['dedicated_theme_sections'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if($key % 2 == 0): ?>
                            <div class="row row-gap padding-bottom ">
                                <div class="col-lg-5 col-md-6 col-12">
                                    <div class="abt-theme">
                                        <div class="section-title">
                                            ...
                                            <h2><?php echo $value['dedicated_theme_section_heading']; ?></h2>
                                            <p> <?php echo $value['dedicated_theme_section_description']; ?> </p>
                                        </div>
                                        <?php if(!empty($value['dedicated_theme_section_cards'][1]['title']) && $value['dedicated_theme_section_cards'][1]['title'] != null && $value['dedicated_theme_section_cards'][1]['title'] != ''): ?>
                                            <div class="theme-acnav">
                                                    <?php $__currentLoopData = $value['dedicated_theme_section_cards']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-lg-7 col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="<?php echo e(check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : get_file($old_path."/image2.png")); ?>" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                            </div>
                        <?php else: ?>
                            <div class="row row-gap  padding-bottom">
                                <div class="col-lg-7  col-md-6 col-12">
                                    <div class="dash-theme-preview">
                                        <img src="<?php echo e(check_file($value['dedicated_theme_section_image']) ? get_file($value['dedicated_theme_section_image']) : get_file($old_path."/image3.png")); ?>" alt="" class="inner-frame-img">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-md-6 col-12">
                                    <div class="abt-theme">
    ...
    <!-- why-choose start -->
    <?php if($marketplace['whychoose_sections_status'] == 'on'): ?>
        <section class="why-choose-section padding-top">
            <div class="container">
                <div class="section-title text-center">
                    <h2><?php echo $marketplace['whychoose_heading']; ?></h2>
                    <p><?php echo $marketplace['whychoose_description']; ?></p>
                </div>
                <div class="pricing-area">
                    <div class="row row-gap">
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="section-title">
                                <h2><?php echo $marketplace['pricing_plan_heading']; ?></h2>
                                <p><?php echo $marketplace['pricing_plan_description']; ?></p>

                            </div>
                            <ul class="variable-list">
                                <?php if(!empty($marketplace['pricing_plan_text'])): ?>
                                    <?php $__currentLoopData = json_decode($marketplace['pricing_plan_text'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li>
                            ...
                            <div class="bg-white tabs-wrapper pricing-tab">
                                <ul class="tabs">
                                    <li class="tab-link active" data-tab="tab-1">
                                        <a href="javascript:;"><?php echo e(__('Monthly')); ?></a>
                                    </li>
                                    <li class="tab-link" data-tab="tab-2">
                                        <a href="javascript:;"><?php echo e(__('Yearly')); ?></a>
                                    </li>
                                </ul>
                                <div class="tabs-container">
                                    <div class="tab-content active" id="tab-1">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl"><?php echo e(__('Billed monthly, or')); ?> <b><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price']).'/'); ?></b><?php echo e(__(' if paid monthly')); ?></div>
                                            <div class="btn-group">
                                                <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Buy Now')); ?> <svg
                                                ...
                                                <a href="<?php echo $marketplace['pricing_plan_demo_link']; ?>" class="link-btn"><?php echo $marketplace['pricing_plan_demo_button_text']; ?><svg
                                    ...
                                    <div class="tab-content" id="tab-2">
                                        <div class="pricing-content">
                                            ...
                                            <div class="lbl"><?php echo e(__('Billed yearly, or')); ?> <b><?php echo e(super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price']).'/'); ?></b><?php echo e(__(' if paid yearly')); ?></div>
                                            <div class="btn-group">
                                                <a href="<?php echo e(route('apps.pricing')); ?>" class="btn-secondary"><?php echo e(__('Buy Now')); ?> <svg
                                                        xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                        viewBox="0 0 16 16" fill="none">
    ...
    <section class="screenshot-section padding-top">
        <div class="container">
            <div class="screenshot-slider">
                <?php if(is_array(json_decode($marketplace['screenshots'], true)) || is_object(json_decode($marketplace['screenshots'], true))): ?>
                    <?php $__currentLoopData = json_decode($marketplace['screenshots'], true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $imageKey = $key + 1 ;
                        ?>
                            <div class="screenshot-itm">
                                <div class="screenshot-image">
                                    <img src="<?php echo e(check_file($value['screenshots']) ? get_file($value['screenshots']) :
                                    (check_file($old_path."/image".$imageKey.".png") ? get_file($old_path."/image".$imageKey.".png") : get_file($old_path."/image3.png"))); ?>" alt="" class="inner-frame-img">
                                </div>
                            </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
    ...
    <!-- addon section start -->
    <?php if($marketplace['addon_section_status'] == 'on'): ?>
        <section class="bg-white padding-top padding-bottom ">
            <div class="container">
                <div class="section-title text-center">
                    <h2><?php echo $marketplace['addon_heading']; ?></h2>
                    <p><?php echo $marketplace['addon_description']; ?></p>
                </div>
...
<?php echo $__env->make('landingpage::layouts.marketplace', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u886959491/domains/stpw.net/public_html/Modules/LandingPage/Resources/views/marketplace/index.blade.php ENDPATH**/ ?>