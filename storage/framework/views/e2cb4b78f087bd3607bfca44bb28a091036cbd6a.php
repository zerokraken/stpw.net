                                ...
                                <?php $__currentLoopData = $plan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $single_plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="basic-plan-card">
                                        <div class="basic-plan text-center mb-4">
                                            ...
                                            <div class="price">
                                                <ins class="per_year_price"><?php echo e(currency_format_with_sym($single_plan->package_price_yearly)); ?><span
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u886959491/domains/stpw.net/public_html/resources/views/plans/planslist.blade.php ENDPATH**/ ?>